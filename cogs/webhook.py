...
class Webhook(commands.Cog):
    ...
    async def echo(self, ctx: discord.ApplicationContext, channel: Option(discord.TextChannel), message: Option(str), username: Option(str), avatar_url: Option(discord.Member)):
        """Echoes a message"""
